...
import { applyNumber, changeOperation, clearDisplay, memorySet } from './actions';
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => dispatch(memorySet(state.total))}/>
              <CalcButton value={"MR"} onClick={() => dispatch(applyNumber(state.memory))}/>
              <CalcButton value={"MC"} onClick={() => dispatch(memorySet(0))}/>
            </div>
